...
%---------------------------------------------------------
  \cventry
    ...
    {Automated Support for Adapting Hardware to Changes in the Architecture of Android} % Organization
...
%---------------------------------------------------------
  \cventry
    {{Software Architectural Research Group}, USC} % Job title
    {Architectural Change and Decay in Open-source Software} % Organization
    {Los Angeles, U.S.} % Location
